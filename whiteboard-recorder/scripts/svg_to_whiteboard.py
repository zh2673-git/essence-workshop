...
流程：
  1. 读取SVG文件
  2. 调用 content-output/scripts/elements/svg_to_png.py 转换为PNG（Playwright渲染，中文字体正确）
...
sys.path.insert(0, str(CONTENT_OUTPUT_SCRIPTS / "elements"))

# 引入已有的svg_to_png（Playwright渲染，中文字体正确）
