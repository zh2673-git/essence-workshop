...
**专栏/故事/教程/观点风格的字数分配原则**：按目标字数等比例压缩，确保开头钩子、核心内容、结尾收束三部分完整，不因为篇幅短而丢失坡度理解。
...
| 段落 | 坡度阶段 | 时长 | 内容 |
|------|---------|------|------|
| 钩子 | 点出概念 | 15-20s | 抛问题 + 点概念 |
| 是什么 | 点出概念 | 30-45s | 一句话定义 + 类比 |
| 为什么 | 建立联系 | 60-90s | 痛点/场景/对比 |
| 怎么做 | 详细解释 | 60-120s | 2-4 个可执行步骤 |
| 收尾 | 详细解释 | 15-30s | 金句 + 行动号召 |
