...
description: |
  ...
  触发词：「探索XX」「拆解XX」「蒸馏XX」「开发XX」「分析XX」「写公众号」「做视频」「做PPT」「HTML交互」「优化skill」「达尔文」「darwin」。
---
...
| **E: 内容输出** | 「写公众号」「做视频」「做PPT」「HTML交互」 | [content-output/](content-output/SKILL.md) | 多管线发布（5条管线+3种风格） |
...
├── project-dev/                     # C: 项目开发
│   ├── SKILL.md
│   ├── C-project-development.md     # 工作流
│   ├── references/                  # 设计原则
│   └── templates/                   # 项目模板（essence/architecture/modules/four-layer）
│
